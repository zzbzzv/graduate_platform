<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['inpatient:inpatient:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['inpatient:inpatient:remove']"
        >删除</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="inpatientList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="入院诊断名-病案" align="center" prop="fDiagnosisIn" />
...
<script>
import { listInpatient, getInpatient, delInpatient, addInpatient, updateInpatient } from "@/api/inpatient/inpatient";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('inpatient/inpatient/export', {
        ...this.queryParams
